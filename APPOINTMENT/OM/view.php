...
<button class="btn btn-outline-dark btn-lg btn-block ">Specjalista</button>
<button class="btn btn-outline-dark btn-lg btn-block ">Badania</button>
<button class="btn btn-outline-dark btn-lg btn-block ">Rehabilitacja</button>
</div>
<?php
}
?>
